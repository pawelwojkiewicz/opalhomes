            ...
            <main id="main" class="site-main" role="main">
                ...
                <?php if (have_posts()) :
                    ...
                    the_posts_pagination(array(
                        'prev_text'          => '<span class="opal-icon-chevron-left"></span><span class="screen-reader-text">' . esc_html__('Previous page', 'opalhomes') . '</span>',
                        'next_text'          => '<span class="screen-reader-text">' . esc_html__('Next page', 'opalhomes') . '</span><span class="opal-icon-chevron-right"></span>',
