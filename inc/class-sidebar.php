...
class opalhomes_setup_sidebar {
    ...
    public function body_class($classes) {
        if (opalhomes_is_product_archive()) {
    ...
    public function init_sidebar(){
        register_sidebar(array(
            'name'          => esc_html__('Blog Sidebar', 'opalhomes'),
            'id'            => 'sidebar-blog',
            'description'   => esc_html__('Add widgets here to appear in your sidebar on blog posts and archive pages.', 'opalhomes'),
    ...
    public function set_sidebar($sidebar) {
        if (opalhomes_is_product_archive() || (function_exists('is_product') && is_product())) {
        } else {
...
return new opalhomes_setup_sidebar();